...
const uri =
  "mongodb+srv://Rubel:pVyqQKPBx8auCtKM@cluster0.l479m.mongodb.net/Topu?retryWrites=true&w=majority";
...
client.connect((err) => {
  const collection = client.db("Topu").collection("Eros");
  const collections = client.db("Topu").collection("Topuimage");
  const ImageCollection = client.db("Topu").collection("TopuNewImage");
